 ...
 */
let AITranslatorElement = class AITranslatorElement extends LitElement {
    constructor() {
        super(...arguments);
        // Public properties
...
AITranslatorElement.styles = css `
    :host {
      display: block;
...
AITranslatorElement = __decorate([
    customElement('ai-translator-element')
], AITranslatorElement);
export { AITranslatorElement };
