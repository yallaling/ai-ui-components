...
exports.AILanguageDetectorElement = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
const web_ai_core_1 = require("@yallaling/web-ai-core");
let AILanguageDetectorElement = class AILanguageDetectorElement extends lit_1.LitElement {
    constructor() {
        super();
        this.text = '';
        ...
        this.detector = new web_ai_core_1.WebAILanguageDetector();
    ...
    render() {
      ...
      <div class="container">
        ...
        ${this.results.length > 0 ? (0, lit_1.html) `
          <div class="results">
            ${this.results.map(result => (0, lit_1.html) `
        ...
        ` : this.isLoading ? '' : this.text && !this.error ? (0, lit_1.html) `
...
exports.AILanguageDetectorElement = AILanguageDetectorElement;
AILanguageDetectorElement.styles = (0, lit_1.css) `
    :host {
      display: block;
...
exports.AILanguageDetectorElement = AILanguageDetectorElement = __decorate([
    (0, decorators_js_1.customElement)('ai-language-detector-element')
