...
exports.WebAIRewriter = void 0;
class WebAIRewriter extends EventTarget {
    constructor() {
        super();
        this.session = null;
    ...
    getSupportedLengths() {
        var _a;
        return ((_a = this.capabilities) === null || _a === void 0 ? void 0 : _a.lengths) || ['shorter', 'as-is', 'longer'];
    }
}
exports.WebAIRewriter = WebAIRewriter;
